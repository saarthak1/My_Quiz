class Question {
  ...
  display(){
    ...
    this.question.html("Question:- What starts  with the letter ‘A’,and ends with‘E’ letter  but has only one letter? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: Airplane " );
    this.option1.position(150, 100);
    this.option2.html("2: Aabade" );
    this.option2.position(150, 120);
    this.option3.html("3:Ate  " );
